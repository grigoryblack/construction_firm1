...
const House4 = () => {
    ...
    const items = [
        {
            id: 1,
            imageSrc: 'src/Page/Components/portfolio/HousePick/House4/f1.jpg',
            altText: 'Первая картинка',
        },
        {
            id: 2,
            imageSrc: 'src/Page/Components/portfolio/HousePick/House4/f2.jpg',
            altText: 'Вторая картинка',
        },
        {
            id: 3,
            imageSrc: 'src/Page/Components/portfolio/HousePick/House4/kd_Page7_Image1.jpg',
            altText: 'Третья картинка',
        },
        {
            id: 4,
            imageSrc: 'src/Page/Components/portfolio/HousePick/House4/plan1.jpg',
            altText: 'Четвертая картинка',
        },
        {
            id: 5,
            imageSrc: 'src/Page/Components/portfolio/HousePick/House4/plan2.jpg',
            altText: 'Четвертая картинка',
        },
    ];
    ...
    return (
        <div className="house-content-wrapper">
            ...
            <div className="subtitle-house-modal">
                <p>
                    Стоимость: <span> от 7 620 000  руб.</span><br/>
                    Общая площадь:<span> 254,72 кв.м</span> <br/>
                    Размеры: <span> 12,56х11,7</span>  <br/>
