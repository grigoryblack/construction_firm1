...
const House5 = () => {
    ...
    const items = [
        {
            id: 1,
            imageSrc: 'src/Page/Components/portfolio/HousePick/House5/kd_Page7_Image1.jpg',
            altText: 'Первая картинка',
        },
        {
            id: 2,
            imageSrc: 'src/Page/Components/portfolio/HousePick/House5/kd_Page8_Image1.jpg',
            altText: 'Вторая картинка',
        },
        {
            id: 3,
            imageSrc: 'src/Page/Components/portfolio/HousePick/House5/f1.jpg',
            altText: 'Третья картинка',
        },
        {
            id: 4,
            imageSrc: 'src/Page/Components/portfolio/HousePick/House5/f2.jpg',
            altText: 'Четвертая картинка',
        },
        {
            id: 5,
            imageSrc: 'src/Page/Components/portfolio/HousePick/House5/plan1.jpg',
            altText: 'Пятая картинка',
        },
        {
            id: 6,
            imageSrc: 'src/Page/Components/portfolio/HousePick/House5/plan2.jpg',
            altText: 'Шестая картинка',
        },
    ];
    ...
    return (
        <div className="house-content-wrapper">
            ...
            <div className="subtitle-house-modal">
                <p>
                    Стоимость: <span> от 7 140 000 руб.</span><br/>
                    Общая площадь:<span> 238,21 кв.м</span> <br/>
                    Размеры: <span> 13,55х16,39</span>  <br/>
                    Количество этажей: <span> 2</span>  <br/>
                    Спальни: <span> 3</span>  <br/>
                    Количество жилых комнат: <span> 5</span>  <br/>
                    Материал стен: <span> кирпич, твинблок  <br/>(возможно строительство из другого материала)</span>
                    <br/><br/>
